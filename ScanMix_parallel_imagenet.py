...
from utils.evaluate_utils import scanmix_big_test2, scanmix_test
...
def main():
    ...
    for epoch in range(start_epoch, p['num_epochs']+1):   
        ...
        q1 = mp.Queue()
        p1 = mp.Process(target=scanmix_big_test2, args=(epoch,net1,net2_clone,test_loader,device_1, q1))
